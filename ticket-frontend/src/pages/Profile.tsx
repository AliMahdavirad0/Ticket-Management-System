      ...
      <Card title="My Ticket Statistics">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div>
            ...
            <p className="text-2xl font-bold">{profile.statistics.total_tickets}</p>
          </div>
          <div>
            <p className="text-gray-500 text-sm">Open</p>
            <p className="text-2xl font-bold text-blue-600">{profile.statistics.open_tickets}</p>
          </div>
          <div>
            <p className="text-gray-500 text-sm">Resolved</p>
            <p className="text-2xl font-bold text-green-600">{profile.statistics.resolved_tickets}</p>
          </div>
          {profile.statistics.assigned_tickets !== undefined && (
            <div>
              <p className="text-gray-500 text-sm">Assigned</p>
              <p className="text-2xl font-bold text-purple-600">{profile.statistics.assigned_tickets}</p>
            </div>
          )}
        </div>
      </Card>
